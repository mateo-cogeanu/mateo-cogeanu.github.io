...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Encode video to file")
    parser.add_argument("-i", "--input_video", required=False, default="exported.avi", help="Path to the input video file")
