...
def main():
    ...
    input_file = args.input_file  # Get the input_file
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Convert encoded file to video")
...
if __name__ == '__main__':
    main()  # Call main() without any arguments
